     ...
     <div class="modal">
       ...
       <div class="wrap">
        ...
        <div class="center">
            <div class="middle">
                <div class="md_l_man">
                    <img src="../../img/partnership_man.png">
                </div>
                
                <div class="md_r_box">
                    <div class="md_r_info">
                           <div class="md_r_info_sub">
                                <input type="text" placeholder="(필수) 이름입력" style="width: 41.3%;height: 40px">
                                <input type="text" placeholder="(필수) 연락처 입력 (010-0000-0000 )" style="width: 41.3%;height: 40px"><br>
                                <input type="text" placeholder="(필수) 이메일 입력(아이디@계정)" style="width: 85.8%;height: 40px">
                                <input type="text" placeholder="(필수) 회사명 입력" style="width: 85.8%;height: 40px"><br>
                           </div>
                    </div> <!--md_r_info end-->
                    ...
                    <div class="title">
                        ...
                        <div class="title_menu">
                            <div class="title_sub">
                               <div>
                                    <input type="radio" value="product@work">제품생산
                               </div>
                               <div>
                                   <input type="radio" value="material@work">원단
                               </div>
                               <div>
                                   <input type="radio" value="online@work">온라인
                               </div>
                               <div>
                                   <input type="radio" value="marketing@work">마케팅
                               </div>    
                               <div>
                                   <input type="radio" value="others@work">기타용품
                               </div>
                            </div>    
                        </div>
                    </div><!--title end-->
                    ...
                    <div class="title_hr"> 
                       ...
                       <div class="md_r_bottom">
                          <div class="md_r_bottom_sub">
                               <input type="text" placeholder="문의제목 입력" style="width: 87.2%"><br>
                               <textarea class="nosize"placeholder="문의내용 입력"
                               style="width: 87.2%;height: 300px"></textarea> <br>
                        
                               <div class="filebox">
                                   <input type="text" id="filename" class="fileName" disabled="disabled" placeholder="이미지 파일 첨부" style="width: 59.5%">
