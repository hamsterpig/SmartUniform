...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="css/about_shop.css">
    <link rel="stylesheet" href="css/mainNav.css">
    
    <title>About_shop</title>
</head>
<body>
    <div class="modal">
        </div>
    ...
    <div class="base">
       <div class="wrap">
        ...
        <div class="main_font">
            <div class="m_font">
                E-MAIL 상담을 통해 궁금증을 해결하세요.
            </div>
            <a href="https://pf.kakao.com/_LxoyAj"><button class="m_btn"><img src="img/icon_c_kakao.png"><span>카카오문의</span></button></a>
        </div>  
        <div class="main_hr">
                <hr>   
        </div>    
        ...
        <!-- 파일 업로드폼  -->
               <form action ="ShopFileUploadAction.do" method="post" enctype="multipart/form-data">
        <div class="center">
            <div class="middle">
                <div class="md_l_man">	
                    <img src="img/about_man.png">
                </div>
                <div class="md_r_box">
                       <div class="md_rbt_sub">
                            <span>E-MAIL 상담 운영 기준</span>
                            <button>평일: 1-2일 후 답변</button>
                            <button>주말/공휴일: 평일순차 답변</button>
                       </div>
                    ...
                    <div class="md_r_info">
                           <div class="md_r_info_sub">
                                <input type="text" name="name" placeholder="(필수) 이름입력" style="width: 49%;height: 40px">
                                <input type="text" name="tel" placeholder="(필수) 연락처 입력 (010-0000-0000 )" style="width: 49%;height: 40px"><br>
                                <input type="text" name="email" placeholder="(필수) 이메일 입력(아이디@계정)" style="width: 49%;height: 40px">
                                <input type="text" name="school"placeholder="학교 입력" style="width: 49%;height: 40px"><br>
                                <input type="text" name="agency"placeholder="구입대리점 입력" style="width: 99%;height: 40px">
                           </div>
                    </div> <!--md_r_info end-->
                    ...
                    <div class="title_hr"> 
                       ...
                       <div class="md_r_bottom">
                          <div class="md_r_bottom_sub">
                               <input type="text" name="title"placeholder="문의제목 입력" style="width: 98%"><br>
                               <textarea class="nosize" name="content"placeholder="문의내용 입력"
                               style="width: 98%;height: 300px"></textarea> <br>
                               
	                                <div class="filebox">
	                                   <input type="text" id="filename" class="fileName" disabled="disabled" placeholder="이미지 파일 첨부" style="width: 70%">
	                                   <label for="uploadBtn" class="btn_file" onclick="">파일첨부</label>
	                                   <input type="file"  name="imgindex"   id="uploadBtn"class="uploadBtn" onchange="javascript:document.getElementById('filename').value=this.value" >
        ...
        <div class="bottom_top">
            <div>
                <input type="checkbox" value="check">개인정보 취급방침에 동의합니다.
            </div>
            <span>전문보기</span>
        </div>    
           ...
           <div class="notice">
            <div class="b_notice">
               <div class="b_notice_show">
                    <p>1.수집하는 개인정보의 항목 및 수집방법</p>
                    <p>사이트는 이용자의 상담을 위해서 아래와 같이 개인정보를 수집하고 있으며 그 외 쿠키를 이용하여 홈페이지 이용자의</p>
                    <p>개인정보를 자동으로 수집하고 있지 않습니다.</p>
                    <p>상담시 수집항목:이름.연락처,학교명,이메일수집방법:스마트 홈페이지 內 고객센터</p>
                </div>
            </div>
            <div class="b_notice_sub">
                 <div class="b_notice_show_sub">
                    <p>2.개인정보의 수집 및 이용목적</p>
                    <p>스마트 홈페이지를 통해 수집된 개인 정보는 상담 및 불만처리 이외의 용도로 사용하지 않습니다.</p>
                </div>
            </div>
        </div><!--notice end-->
        <div class="noti_btn">            
        ...
        <div class="counseling">
            <div class="counseling_sub">
               <div class="couns">
                    <p>고객의 궁금증 해결을 위해 소비자 상담실을 운영중 입니다.</p>
               </div>
               <div class="couns_sub">
                 <p>상담을 이용하시기 전에 FAQ를 이용 하시면문의하시고자 하는 내용을 보다 빨리 확인하실 수 있습니다.</p>
                </div>
                
                <div class="bluebox">
                   <div class="bl_box">
                        <img src="img/icon_headset.png">
                    </div>
                    <div class="bl_text">
                        <p class="p1">소비자 상담실</p>
                        <p class="p2">080-900-3400</p>
                        <hr>
                        <p class="p3">소비자 상담실 운영시간</p>
                        <div class="bl_time">
                            <p class="p4">평일 오전 09 ~ 12시</p>
                            <p class="p5">평일 오후 13~ 18시</p>
                        </div>
                        <p class="p6">토,일 / 공휴일에는 운영을 하지 않습니다.</p>
                    </div>
                </div>
                
                <div class="couns_s_sub">
                    <p>상담 문의가 급증할 경우(2월,5월 등의 판매기간 포함),전화연결이 지연될 수 있음을 양해 바랍니다.</p>
                </div>
                <div class="couns_hr">
                    <hr>
                </div>
                <div class="couns_s_sub2">
                    <p>전화연결이 어려울 경우</p>
                    <p>메일 문의를 이용해 주시면 빠른 시간내에 답변해 드리도록 하겠습니다.</p>
                </div>
            ...
            <div class="bottom">
               <div class="bo_btn">
                    ...
                    <a href="https://www.instagram.com/ilovesmart/"><div><img src="vicon_c_instargram.png"></div></a>
